...
cd ..
log using "results/supplementary_t5_c1", replace text
...
sdid light `X2' year npw_post if ygn != 1, vce(placebo) covariates(`X1') seed(1000) graph
eststo r1_`var'

sdid light `X2' year ygn_post if npw != 1, vce(placebo) covariates(`X1') seed(1000) graph
eststo r2_`var'

esttab r1_* r2_* using "results/supplementary_t5_c1.csv", replace se r2 b(%10.3f) ///
