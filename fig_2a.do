...
cd ..
log using "results/fig_2a", replace text
...
*Define variables
local NPW "npw_19* npw_*00 npw_*01 npw_*03 npw_*04 npw_*05 npw_*06 npw_*07 npw_*08 npw_*09 npw_*02"
local YGN "ygn_19* ygn_*00 ygn_*01 ygn_*03 ygn_*04 ygn_*05 ygn_*06 ygn_*07 ygn_*08 ygn_*09 ygn_*02"
local X "i.year i.township_id i.year##c.log_pop_02 i.year##c.area i.year##c.x i.year##c.y"

*NPW the new capital
reghdfe light `NPW' if ygn != 1, a(`X') cl(district_id)
...
*YGN the new capital
reghdfe light `YGN' if npw != 1, a(`X') cl(district_id)
...
* Limit the x-axis from 1997 to 2009
...
graph export "results/fig_2a.eps", replace
